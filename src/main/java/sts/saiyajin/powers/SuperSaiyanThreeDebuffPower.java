...
public class SuperSaiyanThreeDebuffPower extends AbstractPower {
	...
	public SuperSaiyanThreeDebuffPower(AbstractCreature owner, int amount) {
        ...
        this.region128 = new TextureAtlas.AtlasRegion(new Texture(PowerPaths.SS3_DEBUFF_B), 0, 0, 128, 128);
        this.region48 = new TextureAtlas.AtlasRegion(new Texture(PowerPaths.SS3_DEBUFF), 0, 0, 48, 48);
