...
public class TwizePower extends AbstractPower {
	...
	public TwizePower(AbstractCreature owner, int amount) {
        ...
        this.region128 = new TextureAtlas.AtlasRegion(ImageMaster.loadImage(PowerPaths.TWIZE_B), 0, 0, 128, 128);
        this.region48 = new TextureAtlas.AtlasRegion(ImageMaster.loadImage(PowerPaths.TWIZE), 0, 0, 48, 48);
