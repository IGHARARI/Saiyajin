...
public class BurningSoulPower extends AbstractPower {
	...
	public BurningSoulPower(AbstractCreature owner, final int amount) {
		...
		this.owner = owner;
		this.amount = amount;
        this.region128 = new TextureAtlas.AtlasRegion(ImageMaster.loadImage(PowerPaths.BURNING_SOUL_B), 0, 0, 128, 128);
        this.region48 = new TextureAtlas.AtlasRegion(ImageMaster.loadImage(PowerPaths.BURNING_SOUL), 0, 0, 48, 48);
