...
public class DodgePower extends AbstractPower {
	...
	public DodgePower(AbstractCreature owner, int amount) {
        ...
        this.region128 = new TextureAtlas.AtlasRegion(ImageMaster.loadImage(PowerPaths.DODGE_B), 0, 0, 128, 128);
        this.region48 = new TextureAtlas.AtlasRegion(ImageMaster.loadImage(PowerPaths.DODGE), 0, 0, 48, 48);
