...
public class CantRevivePower extends AbstractPower {
	...
	public CantRevivePower(AbstractCreature owner, int amount) {
        ...
        this.region128 = new TextureAtlas.AtlasRegion(ImageMaster.loadImage(PowerPaths.CANT_REVIVE_B), 0, 0, 128, 128);
        this.region48 = new TextureAtlas.AtlasRegion(ImageMaster.loadImage(PowerPaths.CANT_REVIVE), 0, 0, 48, 48);
