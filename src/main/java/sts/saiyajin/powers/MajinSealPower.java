...
public class MajinSealPower extends AbstractPower {
	...
	public MajinSealPower(AbstractCreature owner, final int amount) {
		...
		this.owner = owner;
		this.amount = amount;
        this.region128 = new TextureAtlas.AtlasRegion(ImageMaster.loadImage(PowerPaths.MAJIN_SEAL_B), 0, 0, 128, 128);
        this.region48 = new TextureAtlas.AtlasRegion(ImageMaster.loadImage(PowerPaths.MAJIN_SEAL), 0, 0, 48, 48);
