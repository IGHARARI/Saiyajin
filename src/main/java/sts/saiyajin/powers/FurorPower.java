...
public class FurorPower extends AbstractPower implements OnApplyPowerActionSubscriber {
	...
	public FurorPower(AbstractCreature owner, int amount, int kiToRegen) {
        ...
        this.region128 = new TextureAtlas.AtlasRegion(ImageMaster.loadImage(PowerPaths.FUROR_B), 0, 0, 128, 128);
        this.region48 = new TextureAtlas.AtlasRegion(ImageMaster.loadImage(PowerPaths.FUROR), 0, 0, 48, 48);
