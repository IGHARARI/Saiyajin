...
public class GreatApePower extends AbstractPower {
	...
	public GreatApePower(AbstractCreature owner, final int amount) {
		...
		this.owner = owner;
		this.amount = amount;
        this.region128 = new TextureAtlas.AtlasRegion(ImageMaster.loadImage(PowerPaths.GREAT_APE_B), 0, 0, 128, 128);
        this.region48 = new TextureAtlas.AtlasRegion(ImageMaster.loadImage(PowerPaths.GREAT_APE), 0, 0, 48, 48);
