...
public class SoulSpicePower extends AbstractPower {
	...
	public SoulSpicePower(AbstractCreature owner, int amount) {
        ...
        this.region128 = new TextureAtlas.AtlasRegion(new Texture(PowerPaths.SOUL_SPICE_B), 0, 0, 128, 128);
        this.region48 = new TextureAtlas.AtlasRegion(new Texture(PowerPaths.SOUL_SPICE), 0, 0, 48, 48);
