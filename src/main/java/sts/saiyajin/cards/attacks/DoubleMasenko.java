...
public class DoubleMasenko extends KiCard {
	...
	public void use(AbstractPlayer player, AbstractMonster monster) {
		...
		AbstractDungeon.actionManager.addToBottom(new DamageAction(mon1, damageInfo, AttackEffect.SLASH_DIAGONAL));
		if (mon2 != null && mon2 != mon1){
			...
			AbstractDungeon.actionManager.addToBottom(new DamageAction(mon2, damageInfo, AttackEffect.SLASH_DIAGONAL));
