...
import sts.saiyajin.ui.vfx.MasenkoBallEffect;
...
//		AbstractDungeon.actionManager.addToBottom(new VFXAction(player, new SmallLaserEffect(player.hb.cX, player.hb.cY, mon1.hb.cX, mon1.hb.cY), 0.1f));
        AbstractDungeon.actionManager.addToBottom(new VFXAction(new MasenkoBallEffect(player.hb.cX, player.hb.cY, mon1.hb.cX, mon1.hb.cY, 1), 0.6f));
...
//			AbstractDungeon.actionManager.addToBottom(new VFXAction(player, new SmallLaserEffect(player.hb.cX, player.hb.cY, mon2.hb.cX, mon2.hb.cY), 0.1f));
			AbstractDungeon.actionManager.addToBottom(new VFXAction(new MasenkoBallEffect(player.hb.cX, player.hb.cY, mon2.hb.cX, mon2.hb.cY, 1), 0.6f));
